  ...
  <el-input v-model="searchInfo.password" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate v-auth="btnAuth.exportTemplate" template-id="ito_user_Users" />
            <ExportExcel v-auth="btnAuth.exportExcel" template-id="ito_user_Users" filterDeleted/>
            <ImportExcel v-auth="btnAuth.importExcel" template-id="ito_user_Users" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="头像" prop="image" width="120" />
    ...
    <el-input v-model="formData.mobile" :clearable="true" placeholder="请输入手机号" />
            ...
            <el-form-item label="头像:" prop="image">
    <el-input v-model="formData.image" :clearable="true" placeholder="请输入头像" />
</el-form-item>
            <el-form-item label="密码:" prop="password">
