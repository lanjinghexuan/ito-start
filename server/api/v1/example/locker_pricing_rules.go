...
// @Param data body example.LockerPricingRules true "创建lockerPricingRules表"
...
func (lockerPricingRulesApi *LockerPricingRulesApi) CreateLockerPricingRules(c *gin.Context) {
	...
	var lockerPricingRules example.LockerPricingRules
...
// @Accept application/json
// @Produce application/json
// @Param data body example.LockerPricingRules true "删除lockerPricingRules表"
...
func (lockerPricingRulesApi *LockerPricingRulesApi) DeleteLockerPricingRules(c *gin.Context) {
	...
	id := c.Query("id")
	err := lockerPricingRulesService.DeleteLockerPricingRules(ctx,id)
	if err != nil {
...
func (lockerPricingRulesApi *LockerPricingRulesApi) DeleteLockerPricingRulesByIds(c *gin.Context) {
	...
	err := lockerPricingRulesService.DeleteLockerPricingRulesByIds(ctx,ids)
	if err != nil {
...
// @Accept application/json
// @Produce application/json
// @Param data body example.LockerPricingRules true "更新lockerPricingRules表"
...
// @Accept application/json
// @Produce application/json
// @Param id query int true "用id查询lockerPricingRules表"
// @Success 200 {object} response.Response{data=example.LockerPricingRules,msg=string} "查询成功"
...
// @Accept application/json
// @Produce application/json
// @Param data query exampleReq.LockerPricingRulesSearch true "分页获取lockerPricingRules表列表"
...
func (lockerPricingRulesApi *LockerPricingRulesApi) GetLockerPricingRulesList(c *gin.Context) {
	...
	var pageInfo exampleReq.LockerPricingRulesSearch
