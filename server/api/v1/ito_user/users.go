...
// @Param data body ito_user.Users true "创建users表"
...
// @Accept application/json
// @Produce application/json
// @Param data body ito_user.Users true "删除users表"
...
// @Accept application/json
// @Produce application/json
// @Param data body ito_user.Users true "更新users表"
...
// @Accept application/json
// @Produce application/json
// @Param ID query uint true "用id查询users表"
...
// @Accept application/json
// @Produce application/json
// @Param data query ito_userReq.UsersSearch true "分页获取users表列表"
